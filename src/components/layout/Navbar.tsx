                ...
                className={`block pl-3 pr-4 py-3 border-l-4 text-base font-medium transition-all duration-300
                  ${
                    isActive(item.href)
                      ...
                      : 'border-transparent text-gray-600 dark:text-gray-300 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-900 dark:hover:bg-gray-800/50 dark:hover:text-white'
                  }`}
